...
<body class="bg-white text-secondary-900 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    <a href="#beranda" class="text-secondary-700 hover:text-primary-600 font-medium transition-colors">Beranda</a>
                    <a href="#cara-kerja" class="text-secondary-700 hover:text-primary-600 font-medium transition-colors">Cara Kerja</a>
                    <a href="#pengaduan" class="text-secondary-700 hover:text-primary-600 font-medium transition-colors">Buat Pengaduan</a>
                    <a href="#kontak" class="text-secondary-700 hover:text-primary-600 font-medium transition-colors">Kontak</a>
                </nav>
                
                <div class="flex items-center space-x-4">
                    <div class="hidden sm:flex items-center space-x-2 text-sm">
                        <i class="fas fa-phone text-primary-600"></i>
                        <span class="text-secondary-700">Hotline: 1500-123</span>
                    </div>
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="space-y-8">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <a href="#pengaduan" class="bg-primary-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-primary-700 transition-colors text-center">
                                <i class="fas fa-edit mr-2"></i>
                                Buat Pengaduan Sekarang
                            </a>
                            <a href="#cara-kerja" class="border-2 border-primary-600 text-primary-600 px-8 py-4 rounded-lg font-semibold hover:bg-primary-50 transition-colors text-center">
                    ...
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=600&h=400&fit=crop&crop=center" 
                            alt="Masyarakat menyampaikan pengaduan" 
                            class="rounded-2xl shadow-2xl w-full h-auto">
                        <div class="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-lg border border-secondary-100">
                            <div class="flex items-center space-x-3">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="text-center group">
                        ...
                        <p class="text-secondary-600">Sampaikan keluhan atau saran Anda melalui formulir yang telah disediakan</p>
                    </div>
                    ...
                    <div class="text-center group">
                        ...
                        <p class="text-secondary-600">Anda akan mendapat update status dan hasil tindak lanjut pengaduan</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="bg-secondary-50 rounded-2xl p-8">
                    <form class="space-y-6" wire:submit.prevent="submitComplaint">
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <label for="agreement" class="text-sm text-secondary-600">
                                ...
                                Saya juga memahami bahwa pengaduan palsu dapat dikenakan sanksi sesuai peraturan yang berlaku.
                            </label>
                        </div>
                    ...
                    <div class="mt-8 p-6 bg-white rounded-lg border border-secondary-200">
                        ...
                        <ul class="space-y-2 text-sm text-secondary-800">
                            ...
                            <li class="font-medium text-secondary-900">• Sertakan foto atau dokumen pendukung jika ada</li>
                            <li class="font-medium text-secondary-900">• Berikan informasi lokasi yang spesifik</li>
                            <li class="font-medium text-secondary-900">• Pastikan data kontak Anda aktif untuk follow-up</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <footer id="kontak" class="bg-secondary-900 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-secondary-300">
                        <li><a href="#" class="hover:text-primary-400 transition-colors">Pengaduan Online</a></li>
            ...
            <div class="border-t border-secondary-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p class="text-secondary-400 text-sm">
                    © 2024 KUPING REZIM. Hak Cipta Dilindungi Undang-Undang.
                </p>
                <div class="flex space-x-6 mt-4 md:mt-0">
                    <a href="#" class="text-secondary-400 hover:text-primary-400 text-sm transition-colors">Kebijakan Privasi</a>
                    <a href="#" class="text-secondary-400 hover:text-primary-400 text-sm transition-colors">Syarat & Ketentuan</a>
                    <a href="#" class="text-secondary-400 hover:text-primary-400 text-sm transition-colors">Sitemap</a>
                </div>
            </div>
        </div>
    </footer>
